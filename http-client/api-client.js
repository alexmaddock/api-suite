...
export const jwt = async () => {
    ...
    let outcome = await fetch(
      'https://securepubads.g.doubleclick.net/pagead/ppub_config?ippd=stackoverflow.com', {
      method: 'GET'
    });

    return outcome/*.json() // not a good place to put this by the looks of it for api related testing since I need to grab different response codes etc
